...
WhatsAppHandler orchestrates the processing of WhatsApp messages
including text and voice notes, and generates appropriate responses
...
export class WhatsAppHandler {
   ...
   * Main handler for incoming WhatsApp webhook
  ...
  public async handleIncomingMessage(
    ...
    try {
      ...
      console.log(`Processing ${parsedMessages.length} message(s)`);
   ...
   * Process a single message (text or voice)
  ...
  private async processTextMessage(message: ParsedMessage): Promise<ProcessedMessage> {
   ...
   * Extract intent/topic from message content
   ...
   * Generate response based on processed message and criteria
  ...
  public generateResponse(
    ...
    const messageContent = processedMessage.transcription ||
   ...
   * Build response text based on message analysis
   ...
   * Shorten response to fit length constraint
